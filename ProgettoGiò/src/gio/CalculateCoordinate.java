...
public class CalculateCoordinate {
    ...
    public static double[] moveByDistance(double lat,double longe, double distance,
            double angle) {
/*
...
*/
    	...
    	double lonDiff = meterToLongitude(toEast, lat);
    	double latDiff = meterToLatitude(toNorth);
    	return new double[] {lat + latDiff, longe+ lonDiff};
    }
}
